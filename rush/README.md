## rush.py
  ...
  - **pics.txt** - ссылки на ресурсы для прикрепления в соотвествии с формой ```<type><owner_id>_<media_id>``` (имя определяется пользователем), **ресурсы должны быть доступны боту**
